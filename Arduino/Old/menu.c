                        ...
                        while (sensorValue == digitalRead(input_carro) && !processoFinalizado)
                        {
                                    ...
                                    diferenca <= 2500 && !executou)
                                {
                                        ...
                                        if (numero1 != 0 && numero2 != 0)
                                        {
                                                ...
                                                erros_encontrados[contador_erros_encontrados] = numero1 * 10 + numero2;
                                                Serial.println(erros_encontrados[contador_erros_encontrados]);
...
void ver_codigos()
{
        ...
        for (int i = 0; i <= contador_erros_encontrados; ++i)
        {
                ...
                {
                        if (erros_encontrados[i] == errosCode[j].code)
                        {
